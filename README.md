...
- **提示词自动补全**：内置 Danbooru 标签自动补全，支持英文、中文、拼音首字母/全拼、模糊搜索、标签分类颜色和热度排序，并通过 Web Worker 与 IndexedDB 缓存保证输入体验。
...
- 提示词自动补全：在正向/反向提示词输入中提供 Danbooru 标签建议，支持中英文、拼音和模糊匹配。
...
- 正向、负面、角色提示词等输入支持标签自动补全，便于快速组合 NAI 常用 tag。
