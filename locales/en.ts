...
export const en: Translations = {
  ...
  status: {
    ...
    connectionLost: 'Connection lost. Please regenerate.',
...
Now, execute Phase 0 and check if configuration exists.`,
  ...
  analytics: {
    ...
    overview: 'Overview',
    totalGenerations: 'Total Generated',
    ...
    modelsRanking: 'Models Ranking',
    usersRanking: 'Active Users Ranking',
    ...
    accessDenied: 'Administrator privileges are required to view this page',
